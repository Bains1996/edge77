...
AWS_SES_FROM_EMAIL = os.getenv("AWS_SES_FROM_EMAIL", "disputes@edge77.app")
...
BREVO_FROM_EMAIL = os.getenv("BREVO_FROM_EMAIL", "audit@edge77.app")
BREVO_FROM_NAME = os.getenv("BREVO_FROM_NAME", "EDGE77 Audit Division")

SENDGRID_API_KEY = os.getenv("SENDGRID_API_KEY")
SENDGRID_FROM_EMAIL = os.getenv("SENDGRID_FROM_EMAIL", "audit@edge77.app")
  ...
  <tr>
    <td style="padding: 36px 40px; color: #1a1a1a; font-size: 14px; line-height: 1.7;">
      ...
      <p style="margin: 0 0 12px 0; font-size: 13px; color: #444;">
        ...
        <a href="mailto:billing@edge77.app" style="color: #2563eb; text-decoration: none;">billing@edge77.app</a>,
    ...
    <td style="background-color: #f0f2f5; padding: 20px 40px; border-top: 1px solid #e0e0e0;">
      ...
      <tr>
        <td style="font-size: 11px; color: #888; line-height: 1.5;">
          ...
          Axal Global Inc. &bull; edge77.app &bull; This is a formal dispute notice.
        </td>
      </tr>
      </table>
    </td>
